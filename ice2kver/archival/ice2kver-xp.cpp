...
int main(int argc, char *argv[]) {
  ...
  FXIcon* xtermicon = new FXPNGIcon(&application, xterm,0,IMAGE_OWNED|IMAGE_KEEP);
  xtermicon->blend(FXRGBA(0,0,0,0));

  application.init(argc, argv);
  FXMainWindow *main=new FXMainWindow(&application, "About Windows", xtermicon, NULL, DECOR_TITLE|DECOR_BORDER|DECOR_MENU|DECOR_CLOSE, 0, 0, 413, 322);
  ...
  FXButton* okbutton = new FXButton(okcont, "OK", NULL, &application, FXApp::ID_QUIT, BUTTON_NORMAL|BUTTON_DEFAULT|LAYOUT_FIX_WIDTH|LAYOUT_FIX_HEIGHT, 0, 0, 75, 23, 3, 3, 2, 3);
