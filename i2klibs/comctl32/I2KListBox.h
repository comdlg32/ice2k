...
*********************************************************************************
* $Id: I2KListBox.h,v 1.43 2006/01/22 17:58:05 fox Exp $                         *
********************************************************************************/
...
*/
class FXAPI I2KListBox : public FXPacker {
  FXDECLARE(I2KListBox)
protected:
  FXButton      *field;
  FXMenuButton  *button;
  FXList        *list;
...
protected:
  I2KListBox(){}
private:
  I2KListBox(const I2KListBox&);
  I2KListBox &operator=(const I2KListBox&);
public:
...
public:
  ...
  /// Constructor
  I2KListBox(FXComposite *p,FXObject* tgt=NULL,FXSelector sel=0,FXuint opts=FRAME_SUNKEN|FRAME_THICK|LISTBOX_NORMAL,FXint x=0,FXint y=0,FXint w=0,FXint h=0,FXint pl=DEFAULT_PAD,FXint pr=DEFAULT_PAD,FXint pt=DEFAULT_PAD,FXint pb=DEFAULT_PAD);
