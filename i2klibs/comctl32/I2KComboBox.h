...
*********************************************************************************
* $Id: I2KComboBox.h,v 1.46 2006/01/27 02:07:44 fox Exp $                        *
********************************************************************************/
#ifndef I2KCOMBOBOX_H
#define I2KCOMBOBOX_H
...
*/
class FXAPI I2KComboBox : public FXPacker {
  FXDECLARE(I2KComboBox)
protected:
  FXTextField   *field;
  I2KMenuButton *button;
  FXList        *list;
  FXPopup       *pane;
protected:
  I2KComboBox(){}
private:
  I2KComboBox(const I2KComboBox&);
  I2KComboBox &operator=(const I2KComboBox&);
public:
...
public:
  ...
  I2KComboBox(FXComposite *p,FXint cols,FXObject* tgt=NULL,FXSelector sel=0,FXuint opts=COMBOBOX_NORMAL,FXint x=0,FXint y=0,FXint w=0,FXint h=0,FXint pl=DEFAULT_PAD,FXint pr=DEFAULT_PAD,FXint pt=DEFAULT_PAD,FXint pb=DEFAULT_PAD);
...
//#ifndef _DO_NOT_OVERRIDE_FXCOMBOBOX
//	#define FXComboBox I2KComboBox
//	#define _DO_NOT_OVERRIDE_FXCOMBOBOX
//#endif
