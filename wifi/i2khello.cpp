...
FXDEFMAP(HelloWindow) HelloWindowMap[] = {
	...
	FXMAPFUNC(SEL_COMMAND,           HelloWindow::ID_REFRESH,  HelloWindow::onCmdRefresh),

	FXMAPFUNC(SEL_COMMAND,           HelloWindow::ID_WIZARD,  HelloWindow::onPageChange),

	FXMAPFUNC(SEL_TIMEOUT,           HelloWindow::ID_ANIMATE_CONNECTING,  HelloWindow::onTimeoutAnimateConnecting),
	FXMAPFUNC(SEL_TIMEOUT,           HelloWindow::ID_SCAN,  HelloWindow::onTimeoutScanning),

	FXMAPFUNC(SEL_PAINT,             HelloWindow::ID_ANIMATE_CONNECTING,  HelloWindow::onPaintAnimateConnecting),

	FXMAPFUNC(SEL_TIMEOUT,           HelloWindow::ID_ANIMATE_SCANNING,  HelloWindow::onTimeoutAnimateScanning),
	FXMAPFUNC(SEL_PAINT,             HelloWindow::ID_ANIMATE_SCANNING,  HelloWindow::onPaintAnimateScanning),
};
...
void connectNetwork(char* ssid, char* key) {
...
long HelloWindow::onPageChange(FXObject* obj,FXSelector sel, void* ptr) {
...
long HelloWindow::onTimeoutScanning(FXObject* obj,FXSelector sel, void* ptr) {
	//puts("Hello!");
...
long HelloWindow::onCmdRefresh(FXObject* obj,FXSelector sel, void* ptr) {
...
HelloWindow::HelloWindow(FXApp *a) : FXMainWindow(a, "Connect to Wireless Network", NULL, NULL, DECOR_TITLE|DECOR_BORDER|DECOR_CLOSE|DECOR_MENU, 0,0,497,360) {
	...
	iconlist = new FXIconList(switcher, NULL, 0, ICONLIST_AUTOSIZE|LAYOUT_FILL_X|LAYOUT_FILL_Y|ICONLIST_DETAILED|ICONLIST_BROWSESELECT|SCROLLERS_DONT_TRACK);
	...
	new FXLabel(cont, "Please wait while Windows connects to the '...' network.");
...
long HelloWindow::onTimeoutAnimateConnecting(FXObject*, FXSelector, void*) {
...
long HelloWindow::onPaintAnimateConnecting(FXObject* obj, FXSelector, void* ptr) {
...
long HelloWindow::onTimeoutAnimateScanning(FXObject*, FXSelector, void*) {
...
long HelloWindow::onPaintAnimateScanning(FXObject* obj, FXSelector, void* ptr) {
	FXEvent* ev = (FXEvent*)ptr;
	FXWindow* win = (FXWindow*)obj;
