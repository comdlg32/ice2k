...
KeyboardProperties::KeyboardProperties(FXApp *a) : FXMainWindow(a, "Keyboard Properties", mainIcon, NULL, DECOR_CLOSE|DECOR_BORDER|DECOR_TITLE, 0,0,0,0, 0,0,2,3, 0,6) {
	...
	rdelay_sld_left_lbl = new FXLabel(rdelay_sld_cnt, "Long", NULL, LAYOUT_FIX_WIDTH);
	...
	rrate_sld_cnt = new FXHorizontalFrame(rrate_cnt,
			LAYOUT_FILL_X,
			0,0,0,0, 0,0,0,0, 10,10);
	rrate_sld_left_lbl = new FXLabel(rrate_sld_cnt, "Slow", NULL, LAYOUT_FIX_WIDTH);
	...
	blink_sld_cnt = new FXHorizontalFrame(blink_cnt,
			LAYOUT_FILL_X,
			0,0,0,0, 0,0,0,0, 10,10);
	blink_sld_left_lbl = new FXLabel(blink_sld_cnt, "None", NULL, LAYOUT_FIX_WIDTH);
	...
	cancel_btn = new FXButton(btncont, "Cancel", NULL, this, ID_DLG_CANCEL, BUTTON_NORMAL|BUTTON_DEFAULT, 0,0,0,0, 19,20,2,3);
	apply_btn = new FXButton(btncont, "&Apply", NULL, this, ID_DLG_APPLY, BUTTON_NORMAL|BUTTON_DEFAULT, 0,0,0,0, 19,19,2,3);
